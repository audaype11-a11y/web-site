      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-card border rounded-2xl overflow-hidden">
            ...
            <div className="h-32 bg-gradient-to-l from-sky-500 to-emerald-500" />

            {/* Avatar */}
            <div className="relative px-6 -mt-16">
              <div className="w-32 h-32 rounded-full border-4 border-background overflow-hidden bg-gradient-to-br from-emerald-200 to-sky-200 dark:from-emerald-800 dark:to-sky-800 mx-auto">
                {doctorImage ? (
                  <img
                    src={doctorImage}
                    alt={doctorName}
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <Stethoscope className="h-12 w-12 text-emerald-600 dark:text-emerald-300" />
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="pt-4 pb-8 px-6 text-center">
              <h1 className="text-2xl font-bold mb-2">{doctorName}</h1>
